					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div
								...
								style="cursor: pointer" onclick="add()">添加店铺</div>
						</div>
	...
	function search() {
		...
		$
				.ajax({
					...
					url : "/taobaos/shop.htm?name=" + name,
					dataType : "json",
					success : function(data) {
						if (data.result == "error") {
							...
							//alert(data.message);
							var dataObj = data.map.shop;
							$("#shoptable  tr:not(:first)").empty();
							$('#name').val("");
							$
									.each(
											dataObj,
