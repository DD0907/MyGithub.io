			...
			<div class="collapse navbar-collapse"
				...
				<div class="navbar-form navbar-left" role="search">
					<div class="form-group">
						<input type="text" class="form-control" placeholder="请输入活动查询"
							id="name">
					</div>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<div class="text-muted bootstrap-admin-box-title">活动</div>
							<div
								class="text-muted bootstrap-admin-box-title pull-right text-warning"
								style="cursor: pointer" onclick="add()">添加活动</div>
					</div>
	...
	function search() {
		...
		$
				.ajax({
					...
					url : "/taobaos/activity.htm?name=" + name,
					dataType : "json",
														...
														.append($td
																...
																.html(
																		'<input type="button" value="修改"  class="btn btn-primary" onclick="update('
																				...
																				+ item.id
																				+ ');" />'));
												$("#activity").after($tr);//最后要把内容放入要绑定的地方
											});
						}
					}
				});
